...
var onAddGame = function onAddGame(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.addGame(data).then(ui.addGameSuccess).catch(ui.addGameFailure);
};
...
var onDeleteGame = function onDeleteGame(event) {
  ...
  api.deleteGame(gameId).then(ui.removeGameSuccess).catch(ui.removeGameFailure);
};
...
var addGame = function addGame(data) {
  return $.ajax({
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://games-library-api.herokuapp.com/',
...
var store = __webpack_require__(3);
var showGamesTemplate = __webpack_require__(14);
...
var addGameSuccess = function addGameSuccess() {
  $('#sign-message').removeClass();
...
var addGameFailure = function addGameFailure() {
  $('#sign-message').removeClass();
...
var removeGameSuccess = function removeGameSuccess() {
  $('#sign-message').removeClass();
...
var removeGameFailure = function removeGameFailure() {
...
module.exports = {
  ...
  addGameFailure: addGameFailure,
  getGamesSuccess: getGamesSuccess,
  clearGames: clearGames,
  removeGameFailure: removeGameFailure,
  removeGameSuccess: removeGameSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <!-- <ul> -->\n  <h1 data-id=\""
    ...
    + "\n    <div></div>\n\n  ID: "
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
